<x-jet-form-section submit="updatePassword">
    ...
    <x-slot name="description">
        ...
        Asegura tu cuenta usando una contraseña larga y aleatoria para mantenerse seguro.
    </x-slot>

    <x-slot name="form">
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="current_password" value="{{-- {{ __('Current Password') }} --}} Contraseña actual" />
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="password" value="{{-- {{ __('New Password') }} --}}Nueva contraseña" />
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="password_confirmation"
                value="{{-- {{ __('Confirm Password') }} --}} Confirmar contraseña" />
