    ...
    <x-slot name="content">
                ...
                <div class="ml-3">
                    ...
                    <div>
                        <div class="text-xs text-gray-500">
                            ...
                            <span class="text-green-500 font-semibold">{{-- {{ __('This device') }} --}}Este
                                dispositivo</span>
                            @else
                            {{-- {{ __('Last active') }} --}} Ultima vez {{ $session->last_active }}
                            @endif
                        </div>
                    </div>
                </div>
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                ...
                --}}
                Por favor ingresa tu contraseña para confirmar si deseas cerrar sesión en otros navegadores en todos tus
                dispositivos.
            ...
            <x-slot name="footer">
                ...
                <x-jet-button class="ml-2" wire:click="logoutOtherBrowserSessions" wire:loading.attr="disabled">
                    {{-- {{ __('Log Out Other Browser Sessions') }} --}}
                    Cerrar sesion de otros navegadores
                </x-jet-button>
            </x-slot>
        </x-jet-dialog-modal>
    </x-slot>
